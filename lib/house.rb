class House
    def line(number)
        "This is #{difference(number)}#{difference2(number)}#{difference3(number)}#{difference4(number)}#{difference5(number)}#{difference6(number)}#{difference7(number)}#{difference8(number)}#{difference9(number)}#{difference10(number)}#{lyrics(number)[0]}the house that Jack built.\n"
    end
